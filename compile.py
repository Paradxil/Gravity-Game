...
class BuildExe:
    def __init__(self):
        ...
        #Version of program
        self.project_version = "6.0"
 
        #License of the program
        self.license = "None"
 
        #Auhor of program
        self.author_name = "Hunter Stratton"
        self.author_email = "paradxil@live.com"
        self.copyright = "Copyright (c) 20015 Hunter Stratton."
 
        #Description
        self.project_description = "Block Platformer."
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ["Levels","Images","art"]
